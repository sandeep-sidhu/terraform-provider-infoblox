...
func TestAccInfobloxCNAMEBasic(t *testing.T) {
	...
	cnameRenamed := fmt.Sprintf("acctest-infoblox-cname-%d-renamed.ovp.bskyb.com", randomInt)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccInfobloxCNAMEUpdateTemplate(cnameRenamed, canonicalUpdate),
				Check: resource.ComposeTestCheckFunc(
					testAccInfobloxCNAMEExists(cnameRenamed, cnameResourceName),
					resource.TestCheckResourceAttr(cnameResourceName, "name", cnameRenamed),
